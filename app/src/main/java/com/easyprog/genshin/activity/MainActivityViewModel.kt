...
class MainActivityViewModel @Inject constructor(private val repositoryMainActivity: MainActivityRepository) :
    ...
    fun createHeroesData(): List<HeroesEntity> {
        ...
        mockData.add(HeroesEntity(id = 1, name = "Итто", avatar = R.drawable.itto, birthday = "06.02", element = "Гео", region = "Инадзума", talentMaterialId = 0))
        mockData.add(HeroesEntity(id = 2, name = "Чжун Ли", avatar = R.drawable.zhongli, birthday = "02.01", element = "Гео", region = "Ли Юэ", talentMaterialId = 0))
        mockData.add(HeroesEntity(id = 3, name = "Венти", avatar = R.drawable.venti, birthday = "03.12", element = "Анемо", region = "Мондштадт", talentMaterialId = 0))
        mockData.add(HeroesEntity(id = 4, name = "Сяо", avatar = R.drawable.xiao, birthday = "10.05", element = "Анемо", region = "Ли Юэ", talentMaterialId = 0))
        mockData.add(HeroesEntity(id = 5, name = "Дилюк", avatar = R.drawable.diluc, birthday = "018.09", element = "Пиро", region = "Мондштадт", talentMaterialId = 0))
